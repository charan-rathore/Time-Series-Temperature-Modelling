  ...
  return (
    <>
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h2>Model Metrics</h2>
          <p>{data.location} · {models.length} model{models.length !== 1 ? 's' : ''} evaluated</p>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
              Day-1 RMSE: {bestModel.rmse.toFixed(4)}°C
            </div>
          </div>
        </div>
      </div>
          ...
          return (
            <div className="card" key={name}>
              ...
              <div className="metric-bar">
                <span className="metric-bar-label">MAE</span>
                ...
                <span className="metric-bar-value">{d1.mae?.toFixed(3) ?? '—'}</span>
              </div>
              <div className="metric-bar">
                <span className="metric-bar-label">RMSE</span>
                <div className="metric-bar-track">
                  <div className="metric-bar-fill" style={{
                ...
                <span className="metric-bar-value">{d1.rmse?.toFixed(3) ?? '—'}</span>
              </div>
              <div className="metric-bar">
                <span className="metric-bar-label">MAPE</span>
                <div className="metric-bar-track">
                  <div className="metric-bar-fill" style={{
              ...
              <div className="metric-bar">
                <span className="metric-bar-label">Skill</span>
                <div className="metric-bar-track">
                  <div className="metric-bar-fill" style={{
